                        ...
                        <div class="p-2">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <p>
                                        @php
                                        echo date('d F, Y', strtotime($news->date))
                                        @endphp
                                    </p>
                                </div>
                                <div class="col-lg-4">
                                    <p>{{$news->comments->count()}} Comments</p>
                                </div>
                                <div class="col-lg-4">
                                    <p><a class="text-decoration-none" href="{{route('news.catagory',$news->catagory->id)}}"> {{$news->catagory->name}}</a> </p>
                                </div>
                            </div>
